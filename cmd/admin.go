...
//func manageServices(adminService interfaces.AdminService) {
//	for {
...
//func viewAllServices(adminService interfaces.AdminService) {
...
//func viewReports(adminService interfaces.AdminService) {
...
//func deactivateUserAccount(adminService interfaces.AdminService) {
//	var userID string
