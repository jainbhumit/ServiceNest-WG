...
type HouseholderService interface {
	ViewApprovedRequests(householderID string, limit, offset int) ([]model.ServiceRequest, error)
	...
	ViewBookingHistory(householderID string, limit, offset int) ([]model.ServiceRequest, error)
	...
	ViewStatus(householderID string, limit, offset int) ([]model.ServiceRequest, error)
