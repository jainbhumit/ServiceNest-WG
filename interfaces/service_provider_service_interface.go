...
type ServiceProviderService interface {
	GetReviews(providerID string, limit, offset int) ([]model.Review, error)
	ViewApprovedRequestsByProvider(providerID string, limit, offset int) ([]model.ServiceRequest, error)
	...
	GetAllServiceRequests(providerId string, limit, offset int) ([]model.ServiceRequest, error)
