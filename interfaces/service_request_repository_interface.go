...
type ServiceRequestRepository interface {
	...
	GetServiceRequestsByHouseholderID(householderID string, limit, offset int) ([]model.ServiceRequest, error)
	GetServiceRequestByID(requestID string) (*model.ServiceRequest, error)
	SaveServiceRequest(request model.ServiceRequest) error
	GetServiceRequestsByProviderID(providerID string, limit, offset int) ([]model.ServiceRequest, error)
	GetServiceProviderByRequestID(requestID, providerID string) (*model.ServiceRequest, error)
	GetApproveServiceRequestsByHouseholderID(householderID string, limit, offset int) ([]model.ServiceRequest, error)
	GetAllPendingRequestsByProvider(providerId string, limit, offset int) ([]model.ServiceRequest, error)
}
